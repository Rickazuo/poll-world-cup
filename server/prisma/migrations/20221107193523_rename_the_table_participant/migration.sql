/*
  ...
  - You are about to drop the `Parcipant` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropIndex
DROP INDEX "Parcipant_userId_poolId_key";

-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "Parcipant";
